...
const carloStudent = new Student("Kevin", 22, ["NodeJs", "Javascript"])
...
const myRepo = new Repository("LaunchX", "kevin garcia", "js", 5)
console.log(myRepo.getInfo())

// Ejemplo 5: Atributos con valores por default
class PullRequest {
  constructor(repo ="LaunchX", title="Mi titulo", lines_changed ="4000"){
    this.repo = repo
    this.title = title
...
const missionCommanderNode = new MissionCommander("Kevin G", "NodeJS")
...
const KevinDev = new Developer("Kevin", "js", ["elixir", "groovy", "lisp"])
console.log(KevinDev)
...
const KegaraLaunchX = new LaunchXStudent("Kegara", "js", ["elixir", "groovy", "lisp"])
console.log(KegaraLaunchX)
console.log(KegaraLaunchX.getName) // getter de la clase padre rehusada en la clase hija
...
const viajero1 = new Viajero("Kevin", "LaunchX", "Node JS", "Abril 2022")
